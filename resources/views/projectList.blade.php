                  ...
                  <tbody>
                    ...
                    <tr>
                        ...
                        <div class="d-flex px-2 py-1">
                          <div>
                            @if($display["project_type"] == 1)
                              <img src="../assets/img/carousel-3.jpg" class="avatar avatar-sm me-3" alt="user4">
                            @elseif($display["project_type"] == 2)
                              <img src="../assets/img/carousel-2.jpg" class="avatar avatar-sm me-3" alt="user4">
                            @endif
                          </div>
                          <div class="d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm">{{$display["project_title"]}}</h6>
                            <p class="text-xs text-secondary mb-0">
                              @if($display["project_type"] == 1)
                                Development Project
                              @elseif($display["project_type"] == 2)
                      ...
                      <td class="align-middle text-center text-sm">
                        ...
                        <span class="badge badge-sm bg-gradient-success">On Track</span>
                        @elseif($display["project_progress"] == 2)
                        <span class="badge badge-sm bg-gradient-warning">Delayed</span>
                        @elseif($display["project_progress"] == 3)
                        <span class="badge badge-sm bg-gradient-info">Extended</span>
                        @elseif($display["project_progress"] == 4)
                      ...
                      <td class="align-middle">
                        <a href="{{'delProject/'.$display['project_id']}}" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                          Delete
                        </a>
                        <a href="{{'editPage/'.$display['project_id']}} " class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                          Edit
                        </a>
                      </td>
                    </tr>
