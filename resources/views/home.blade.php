              ...
              <div class="col-12">
                  <nav class="main-nav">
                      ...
                      <a href="/home" class="logo">
                          <img src="assets/images/updated/FYPRocketColoured.png" alt="FYP Rocket Logo">
                      </a>
                      <!-- ***** Logo End ***** -->
                      <!-- ***** Menu Start ***** -->
                      <ul class="nav">
        ...
        <div class="col-lg-6 align-self-center">
          <div class="header-text">
            ...
            <div class="main-button-gradient">
              <div class="scroll-to-section"><a href="#contact-section">Login Now!</a></div>
            </div>
          </div>
        </div>
        <div class="col-lg-6">
          ...
          <div class="owl-service-item owl-carousel">
            ...
            <div class="item">
              <div class="service-item">
                ...
                <p>Create project for students and assign their supervisor and examiners.</p>
              </div>
            </div>
            <div class="item">
              <div class="service-item">
